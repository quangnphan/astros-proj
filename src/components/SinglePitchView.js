      ...
      {selectedPitchType && (
        <div>
          <div className="pitch-type-info">
            ...
            <p>
              Average Pitch Speed: {averagePitchSpeed.toFixed(2)} MPH
            </p>
            <p>
              Average Plate Speed: {averagePlateSpeed.toFixed(2)} MPH
            </p>
            <p>
              Average Strikezone Top: {averageStrikeZoneTop.toFixed(2)} MPH
            </p>
            <p>
